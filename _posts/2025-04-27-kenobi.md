...
tags: ["linux", "smb", "nfs", "suid", "privesc"]
image:
  path: /assets/images/kenobi/banner.png
---

# Kenobi
![Kenobi Room Banner](/assets/images/kenobi/banner.png){: .shadow .rounded-10 }
...
```
![](/assets/images/kenobi/01_smb_enum.png)
...
smbclient //<IP>/<SHARE>
```
![](/assets/images/kenobi/02_smbclient.png)
...
![](/assets/images/kenobi/03_log_content.png)
...
```
![](/assets/images/kenobi/04_nfs_enum.png)
...
![](/assets/images/kenobi/05_searchsploit.png)
#### About the exploit
...
![](/assets/images/kenobi/06_nc_ftp_cpfr.png)
...
ls -la /mnt/kenobiNFS
```
![](/assets/images/kenobi/07_mount_nfs.png)
then  i SSH into kenobi's account with the private key (using sudo)
![](/assets/images/kenobi/08_ssh_kenobi.png)
...
```
![](/assets/images/kenobi/09_find_suid.png)
